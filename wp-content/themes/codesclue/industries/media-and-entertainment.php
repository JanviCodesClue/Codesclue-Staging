...
get_header(); ?>  
    ...
    <main>
        <section class="media-hero d-flex align-items-center justify-content-center text-center">
 ...
 <section class="entertainment-services">
    <div class="container entertainment-container">
      ...
      <!-- Carousel Start -->
      <div id="entertainmentCarousel" class="carousel slide entertainment-carousel" data-bs-ride="carousel">
