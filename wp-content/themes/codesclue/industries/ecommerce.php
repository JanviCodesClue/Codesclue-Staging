    ...
    <main class="main">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-12 shopping-text order-2 order-lg-1">
                        ...
                        <a href="<?php echo home_url('/contact-us/'); ?>" class="btn-explore">INQUIRY NOW →</a>
                    </div>
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-12">
                        ...
                        <h2>
                            Custom ECommerce Software Solutions – The Codesclue Advantage
                        </h2>
                    </div>
        ...
        <div class="container">
                    ...
                    <div class="row align-items-stretch g-3">
                        ...
                        <div class="col-md-4">
                            <div class="feature-card" data-target="#detail1">
                                <div class="feature-icon-Development">👨‍💻</div>
            ...
            <div class="d-none">
                ...
                <!-- Detail 2 -->
                <div id="detail2">
                    <p>At CodesClue, we understand the value of speed in today’s fast paced digital landscape.</p>
                ...
                <div id="detail4">
                    ...
                    <p>Get the perfect balance of quality, speed, and cost with CodesClue’s competitive pricing.</p>
                </div>

                <!-- Detail 5 -->
                <div id="detail5">
                    <p>At CodesClue, we understand that every business has unique needs and goals. That’s why we offer
