...
<main class="hiring-main">
        ...
        <section class="hiring-bg hire-android-developer-bg">
            <div class="container">
                <div class="row align-items-center">
                  <div class="col-lg-7">
                     <h1 class="hiring-h1 text-light">Hire <span class="text-primary">iOS</span> Developers</h1>
                     <p class="hiring-des text-light hiring-mt-16">Develop cutting-edge iOS
        ...
        <section class="mt-40-hiring light-blue-hiring">
            <div class="container">
                <h2 class="section-heading text-center">Hire iOS Application Developers in just 4 Steps</h2>
        ...
        <section class="expertise-blue-bg">
            <div class="container">
                <h2 class="text-center section-heading text-light">Our Expertise In iOS</h2>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-briefcase icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                        iOS Mobile App Consulting
                    </div>
                </div>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-watch-smart icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                        Wearable App for Apple Watch
                    </div>
                </div>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-vr-cardboard icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-pencil-ruler icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                        Custom iOS App UI/UX Design
                    </div>
                </div>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-robot icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                        Intelligent BOT and Chat App
                    </div>
                </div>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-tv icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-location-dot icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-video icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-truck-fast icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-dumbbell icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="hiring-developers-card bg-hiring-pink">
                        <div class="d-flex align-items-center">
                            <i class="fa-solid fa-mobile-screen me-3 font-18"></i>
                            <h3 class="step-hiring-h3">Extensive Native iOS Expertise</h3>
                        </div>
                        <p class="content-desc-hiring hiring-mt-16">
                            At CodesClue, we target every development endeavor with a new approach, creating industry benchmarks. Backed with over a decade of experience, native app development technology and a strong dedicated team of iOS app developers in India, our iOS development services are guaranteed for excellence in terms of innovation and infinite scalability.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                    <div class="hiring-developers-card bg-hiring-perpol">
                        <div class="d-flex align-items-center">
                            <i class="fa-solid fa-users-gear me-3 font-18"></i>
                            <h3 class="step-hiring-h3">Rapid Access to Talent Pool</h3>
                        </div>
                        <p class="content-desc-hiring hiring-mt-16">
                            Within a few days of your formal approval, you get access to our developer(s) and SCRUM master. Our dedicated iOS app developer's team is passionate about clean code and sharp performance of your next-gen iOS app. They work dedicatedly to serve your project with full assurance of quality.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                    <div class="hiring-developers-card bg-hiring-yellow">
                        <div class="d-flex align-items-center">
                            <i class="fa-solid fa-headset me-3 font-18"></i>
                            <h3 class="step-hiring-h3">Ongoing Technical Support</h3>
                        </div>
                        <p class="content-desc-hiring hiring-mt-16">
                            Whether it is about maintenance or the next round of iOS app development, our iOS developers provide you support and assistance to make your experience effortless while maximizing productivity and ensuring incremental improvements.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                    <div class="hiring-developers-card bg-hiring-green">
                        <div class="d-flex align-items-center">
                            <i class="fa-solid fa-layer-group me-3 font-18"></i>
                            <h3 class="step-hiring-h3">Scalable Implementation</h3>
                        </div>
                        <p class="content-desc-hiring hiring-mt-16">
                            We have got a highly skilled team of experts that makes faster implementation of any iOS solution with ease. We have the ability to rapidly scale the development potential.
                        </p>
                    </div>
                </div>
