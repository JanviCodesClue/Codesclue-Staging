...
<main class="hiring-main">
        ...
        <section class="hiring-bg hire-android-developer-bg">
            <div class="container">
                <div class="row align-items-center">
                  <div class="col-lg-7">
                     <h1 class="hiring-h1 text-light">Hire <span class="text-primary">Node.js</span> Developers</h1>
                     <p class="hiring-des text-light hiring-mt-16">Our skilled Node.js developers build real-time, scalable, and high-speed applications. Whether you need an API-driven back-end or a full-stack solution, our experts ensure a seamless development process.</p>
        ...
        <section class="mt-40-hiring light-blue-hiring">
            <div class="container">
                <h2 class="section-heading text-center">Hire Node.js Developers in just 4 Steps</h2>
       ...
       <section class="expertise-blue-bg">
            <div class="container">
                <h2 class="text-center section-heading text-light">Our Expertise In Node.js</h2>
                <div class="row justify-content-center">
                    <!-- Card 1 -->
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            <div class="card-number">01</div>
                            <i class="fa-solid fa-server icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        ...
                        <div class="card-text">
                            Real-time Node.js development for Chat and Data Streaming.
                        </div>
                    </div>
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-cubes icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-cloud-arrow-up icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-chart-line icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        ...
                        <div class="card-text">
                            Node.js Plugin, Package and API development
                        </div>
                    </div>
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        ...
                        <div class="card-text">
                            Node.js Support, Maintenance and Testing Service
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-green">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Expertise & Experience </h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Our Node.js developers ensure you get enterprise grade performance out of utilizing Node.js technology as a backend. We also have inhouse team of AWS, Google and Microsoft Azure cloud experts to empower the development with right server infrastructure that is designed to scale.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-pink">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Flexibility</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">We provide Node.js developers on hire model which is a very flexible service. You can add and remove developers as per your business needs which gives you ability to scale when required. There are no fixed overheads or expenses which you would have when hiring inhouse developers.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-yellow">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Transparent Cost Model</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">We believe trust is an essential factor to sustain the relationships for long and that can be gained by bringing results. With a transparent cost model we insist to keep the processes and price transparent and client-relationships stronger.
                            </p>
                        </div>
                    </div>
                </div>
