...
get_header(); ?>
    ...
    <main class="hiring-main">
        ...
        <section class="hiring-bg hire-android-developer-bg">
            <div class="container">
                <div class="row align-items-center">
                  <div class="col-lg-7">
                     <h1 class="hiring-h1 text-light">Hire <span class="text-primary">Automated</span> QA</h1>
                     <p class="hiring-des text-light hiring-mt-16">Ensure bug-free software with
                            our
        ...
        <section class="mt-40-hiring light-blue-hiring">
            <div class="container">
                <h2 class="section-heading text-center">Hire Automated QA in Just 4 Steps</h2>
        ...
        <section class="expertise-blue-bg">
            <div class="container">
                <h2 class="text-center section-heading text-light">Our Expertise In Automated QA</h2>
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-clock icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-users icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-user-shield icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-signal icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-green">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Automated Testing in CI-CD </h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">DevOps based implementation requires
                            continuous integration and continuous delivery (CI-CD), whereby testing as much as and as
                            early as possible is inevitable. This is made possible using Automated Testing.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-pink">
                            ...
                            <p class="content-desc-hiring hiring-mt-16">Our Project Management, Design,
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-perpol">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Always On Schedule</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Delivery date is important for every
                            ...
                            solves it as part of our CI-CD implementation.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-yellow">
                            ...
                            <p class="content-desc-hiring hiring-mt-16">Scalability is among our top priority
                            when designing software architecture and delivering the project. We implement load testing,
                            performance testing, security testing and related best practices to ensure that your web or
                            mobile application can scale with ease.
                            </p>
                        </div>
                    </div>
                </div>
