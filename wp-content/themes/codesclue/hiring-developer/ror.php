<?php
/**
 * Template Name: Hire RoR Developers Page
 *
 * @package CodesClue
 */
get_header(); ?>
    ...
    <main>
        <!-- Hero section -->
        <section class="main-hero-section ror-bg d-flex align-items-center py-cus" id="heroSection">
            <div class="container">
                <div class="row align-items-center g-4">

                    <div class="col-xl-7 col-lg-7 col-md-12 text-lg-start">

                        <h1 class="h1-font-style font-48 mb-2 text-white text-left">Hire RoR Developers
                        </h1>
                        <p class="hero_description fw-500 text-white mb-0 mt-0 text-left">Leverage the power of Ruby on
                            Rails
                            with our experienced RoR developers. We build secure, high-performing, and scalable web
                            applications, ensuring faster development cycles and cost-effective solutions.</p>
            ...
            <div class="container">
                <div class="row mx-0 px-0">
                    ...
                    <div class="col-lg-5 col-12 ps-lg-4 px-0">
                        <h2 class="section-sub-title text-left">Hire RoR Developers in just 4
                            Steps</h2>
                        ...
                        <a href="<?php echo home_url('/hire-ror-developers/'); ?>"
        ...
        <section class="section-40 pt-0 service__section" id="serviceSection">
            <div class="container">
                <h2 class="section-title text-left ">Our Expertise In RoR</h2>
                <div class="d-flex mt-md-4  mb-md-0 my-2 justify-content-lg-start justify-content-center flex-wrap">
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                ...
                                <span class="content-desc text-center py-2">Custom RoR Web Application
                                    Development</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">Ruby on Rails API Development</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">RoR-based SaaS Application
                                    Development</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">E-commerce & Marketplace Solutions</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">RoR Microservices & Cloud Integration</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">Ruby on Rails Performance
                                    Optimization</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">RoR Code Audit & Security Enhancement</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">RoR Application Maintenance & Support</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="benefit__card__section section-40 mt-2 gap-md-4 gap-3 pb-0">
                    ...
                    <div class="benefit__card  p-md-3 p-2 border-radius">
                        ...
                        <p class="content-desc mb-0 mt-md-3 mt-2 text-lg-start ">Ruby on Rails allows for
                            fast development
                    ...
                    <div class="benefit__card  p-md-3 p-2 border-radius">
                        ...
                        <p class="content-desc mb-0 mt-md-3 mt-2 text-lg-start ">RoR follows a structured
                            approach,
                    ...
                    <div class="benefit__card  p-md-3 p-2 border-radius">
                        ...
                        <p class="content-desc mb-0 mt-md-3 mt-2 text-lg-start ">Ruby on Rails provides
                            built-in security
                    ...
                    <div class="benefit__card  p-md-3 p-2 border-radius">
                        ...
                        <p class="content-desc mb-0 mt-md-3 mt-2 text-lg-start ">The active RoR community
                            ensures
