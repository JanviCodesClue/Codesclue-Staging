...
<main class="hiring-main">
        ...
        <section class="hiring-bg hire-android-developer-bg">
            <div class="container">
                <div class="row align-items-center">
                  <div class="col-lg-7">
                     <h1 class="hiring-h1 text-light">Hire <span class="text-primary">Java</span> Developers</h1>
                     <p class="hiring-des text-light hiring-mt-16">Develop enterprise-grade
        ...
        <section class="mt-40-hiring light-blue-hiring">
            <div class="container">
                <h2 class="section-heading text-center">Hire Java Developers in just 4 Steps</h2>
        ...
        <section class="expertise-blue-bg">
            <div class="container">
                <h2 class="text-center section-heading text-light">Our Expertise In Java</h2>
               <div class="row justify-content-center">
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-plug icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-bolt icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                        Real-time Applications with Java
                    </div>
                </div>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    ...
                    <div class="card-text">
                        Java-based Progressive Web Apps (PWA)
                    </div>
                </div>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-plug-circle-check icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                        Java Plugin & API Integration
                    </div>
                </div>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-rotate icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                        Java Migration & Legacy System Modernization
                    </div>
                </div>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    ...
                    <div class="card-text">
                        Custom Java Network Applications
                    </div>
                </div>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    ...
                    <div class="card-text">
                        Java Support, Maintenance & Testing Services
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-green">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Robust & Scalable Solutions </h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Our Java developers specialize in building secure, scalable, and high-performance applications. Whether it's a web app, enterprise system, or microservices architecture, we ensure a robust Java-based solution tailored to your business needs.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-pink">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Cross-Platform Compatibility</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Java's platform-independent nature allows us to create applications that run seamlessly across different operating systems. This ensures broader reach, flexibility, and better performance for your business applications.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-perpol">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Enterprise-Grade Security</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Security is a top priority in Java development. Our Java developers integrate secure coding practices, encryption, and authentication mechanisms to ensure your applications are protected against vulnerabilities and cyber threats.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-yellow">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Cloud & Microservices Expertise</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Our Java experts leverage microservices architecture and cloud-based deployment (AWS, Google Cloud, Azure) to make your applications more efficient, scalable, and future-ready.
                            </p>
                        </div>
                    </div>
                </div>
