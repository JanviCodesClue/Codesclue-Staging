...
<main class="hiring-main">
        ...
        <section class="hiring-bg hire-android-developer-bg">
            <div class="container">
                <div class="row align-items-center">
                  <div class="col-lg-7">
                     <h1 class="hiring-h1 text-light">Hire <span class="text-primary">Flutter</span> Developers</h1>
                     <p class="hiring-des text-light hiring-mt-16">Want a single codebase for both iOS
        ...
        <section class="mt-40-hiring light-blue-hiring">
            <div class="container">
                <h2 class="section-heading text-center">Hire Flutter Developers in just 4 Steps</h2>
        ...
        <section class="expertise-blue-bg">
            <div class="container">
                <h2 class="text-center section-heading text-light">Our Expertise In Flutter</h2>
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-solid fa-gamepad icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
                ...
                <div class="col-md-expertise-hirig hiring-mt-16">
                    <div class="expertise-card position-relative">
                        ...
                        <i class="fa-brands fa-flutter icon-size-hiring"></i>
                    </div>
                    <div class="card-text">
            ...
            <div class="container">
                ...
                <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                    <div class="hiring-developers-card bg-hiring-perpol">
                        <div class="d-flex align-items-center">
                            <i class="fa-solid fa-chart-line me-3 font-18"></i>
                            <h3 class="step-hiring-h3">Excellent Track Record</h3>
                        </div>
                        <p class="content-desc-hiring hiring-mt-16">
                            CodesClue has proven expertise in building cross-platform mobile apps using the recent technology, Flutter. Such applications run seamlessly across diverse devices operating on iOS or Android. One team. One code. One project and one app. But you reach out to two streams of OS (Operating System) namely, iOS and Android.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                    <div class="hiring-developers-card bg-hiring-yellow">
                        <div class="d-flex align-items-center">
                            <i class="fa-solid fa-paintbrush me-3 font-18"></i>
                            <h3 class="step-hiring-h3">Excellent Design</h3>
                        </div>
                        <p class="content-desc-hiring hiring-mt-16">
                            In addition to the functionality and performance, the interface design and interactivity features are also critical for a mobile app. To render this, CodesClue deploys the huge collection of ready-made widgets available in Flutter to take the visual aesthetics of the app to a greater level.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                    <div class="hiring-developers-card bg-hiring-green">
                        <div class="d-flex align-items-center">
                            <i class="fa-solid fa-gears me-3 font-18"></i>
                            <h3 class="step-hiring-h3">Excellent Customization</h3>
                        </div>
                        <p class="content-desc-hiring hiring-mt-16">
                            At CodesClue, we take utmost care to ensure that every app we develop is uniquely built for every business challenge. We help our clients get the much-needed competitive edge to outperform their business competitors by providing them with excellently customized Flutter mobile apps.
                        </p>
                    </div>
                </div>
