...
<main class="hiring-main">
        ...
        <section class="hiring-bg hire-android-developer-bg">
            <div class="container">
                <div class="row align-items-center">
                  <div class="col-lg-7">
                     <h1 class="hiring-h1 text-light">Hire <span class="text-primary">.NET</span> Developers</h1>
                     <p class="hiring-des text-light hiring-mt-16">Hire dedicated .NET developers
                            from CodesClue to accelerate your project with cutting-edge Microsoft technologies. Build secure,
        ...
        <section class="mt-40-hiring light-blue-hiring">
            <div class="container">
                <h2 class="section-heading text-center">Hire .NET Developers in just 4 Steps</h2>
        ...
        <section class="expertise-blue-bg">
            <div class="container">
                <h2 class="text-center section-heading text-light">Our Expertise In Android</h2>
                <div class="row justify-content-center">
                    <!-- Card 1 -->
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            <div class="card-number">01</div>
                            <i class="fa-solid fa-code icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-chart-column icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-brands fa-microsoft icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-database icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-microchip icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-headset icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-sitemap icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
                            SAP, Salesforce, QuickBooks, Sage etc.
                        </div>
                    </div>
                    <!-- Card 12 -->
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        <div class="expertise-card position-relative">
                            ...
                            <i class="fa-solid fa-network-wired icon-size-hiring"></i>
                        </div>
                        <div class="card-text">
        ...
        <section class="mt-40-hiring">
            <div class="container">
                ...
                <h2 class="section-heading hiring-mt-16">How Hiring Web Developers Can Benefit Your Business?</h2>
                <div class="row">
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-green">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Proactive Security Practices </h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">In ASP.NET MVC several security
                            measures like Authentication (forms as well as Windows), authorization, Cross Site Scripting (XSS), Cross Site Request
                            Forgery (CSRF) and others can be implemented. We follow 38 point checklist for development
                            best practices that needs to be implemented to ensure security of your bespoke platform.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-pink">
                            ...
                            <p class="content-desc-hiring hiring-mt-16">We take a WHY, WHAT and HOW approach,
                            whereby we understand WHY behind the concept to understand your business needs. We define WHAT in terms of
                            technical specifications which we discuss with you thereby suggesting HOW which is turnkey
                            execution of your concept from design to deployment.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-perpol">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Talent At Your Fingertips</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Glad of our recruitment, training and
                            mentoring methods that we have built a strong team of ASP.Net developers that helps you leverage the development
                            bandwidth for your project.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-yellow">
                            <div class="d-flex align-items-center">
                                <i class="fa-solid fa-file-shield me-3"></i>
                                <h3 class="step-hiring-h3">Source Code Ownership and IP Protection</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">We ensure you have complete ownership
                            of the source code as well as Intellectual Property (IP) Rights for the work done by us. We write clean code,
                            which is well commented and lean. We have three layers of code review process in place to
                            ensure quality coding standards.
                            </p>
                        </div>
                    </div>
                </div>
