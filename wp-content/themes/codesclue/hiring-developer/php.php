...
<main class="hiring-main">
        ...
        <section class="hiring-bg hire-android-developer-bg">
            <div class="container">
                <div class="row align-items-center">
                  <div class="col-lg-7">
                     <h1 class="hiring-h1 text-light">Hire <span class="text-primary">PHP</span> Developers</h1>
                     <p class="hiring-des text-light hiring-mt-16">Looking for a PHP developer? Our PHP experts build dynamic, feature-rich, and high-performance web applications with clean and secure code. Get reliable PHP solutions for your web development needs.</p>
       ...
       <section class="expertise-blue-bg">
            <div class="container">
                <h2 class="text-center section-heading text-light">Our Expertise In PHP</h2>
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        ...
                        <div class="card-text">
                            PHP API & Web Service Integration
                        </div>
                    </div>
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        ...
                        <div class="card-text">
                            PHP-based CMS Development (WordPress, Drupal)
                        </div>
                    </div>
                    ...
                    <div class="col-md-expertise-hirig hiring-mt-16">
                        ...
                        <div class="card-text">
                            PHP Application Maintenance & Support
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-green">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Versatile & Cost-Effective</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">PHP is a cost-effective and flexible language widely used for web development. It is compatible with all major servers and supports a variety of databases, making it an excellent choice for businesses of all sizes.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-pink">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Fast Development Cycle</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">PHP's open-source nature and vast library of frameworks (Laravel, CodeIgniter, Symfony) help businesses develop and launch their applications faster with less coding effort.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-perpol">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Scalability & High Performance</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">PHP-based applications are highly scalable and work efficiently even with high traffic. It supports caching mechanisms and integrates seamlessly with cloud environments.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-yellow">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Wide Hosting Compatibility</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">PHP works on almost all hosting services, making it easy to deploy and manage websites or applications without additional server costs.
                            </p>
                        </div>
                    </div>
                </div>
