<?php
/**
 * Template Name: Hire React Js Developer Page
 *
 * @package CodesClue
 */
get_header(); ?>
    ...
    <main>
        <!-- Hero section -->
        <section class="main-hero-section android-bg d-flex align-items-center py-cus" id="heroSection">
            <div class="container">
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-12 text-lg-start">
                        ...
                        <h1 class="h1-font-style font-48 mb-2 text-white text-left">Hire React.js Developers
                        </h1>
                        <p class="hero_description fw-500 text-white mb-0 mt-0 text-left">Leverage the power of React.js
                            with our
                            experienced developers who build fast, responsive, and intuitive user interfaces.
                            Whether you need a single-page application or a complex web solution, our React.js
                            developers deliver seamless and scalable applications.</p>
                        <!-- <a href="<?php echo home_url('/contact-us/'); ?>" class="btn btn-secondary px-4 py-3" >Contact
                                us</a> -->
            ...
            <div class="container">
                <div class="row mx-0 px-0">
                    ...
                    <div class="col-lg-5 col-12 ps-lg-4 px-0">
                        <h2 class="section-sub-title text-left">Hire React.js Developers in just 4
                            Steps</h2>
                        ...
                        <a href="<?php echo home_url('/hire-react-js-developer/'); ?>"
        ...
        <section class="section-40 pt-0 service__section" id="serviceSection">
            <div class="container">
                <h2 class="section-title text-left ">Our Expertise In React.js</h2>
                <div class="d-flex mt-md-4  mb-md-0 my-2 justify-content-lg-start justify-content-center flex-wrap">
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            ...
                            <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                <span class="content-desc text-center py-2">Enterprise React.js Web Application</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            ...
                            <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                <span class="content-desc text-center py-2">React.js Support, Maintenance and
                                    Testing</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            ...
                            <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                <span class="content-desc text-center py-2">React.js Web Development Services</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            ...
                            <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                <span class="content-desc text-center py-2">Custom React.js Development</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            ...
                            <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                <span class="content-desc text-center py-2">React.js Migration services</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            ...
                            <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                <span class="content-desc text-center py-2">UI Integration Existing App</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            ...
                            <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                <span class="content-desc text-center py-2">React.js Integration with various Amazon
                                    MicroServices</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            ...
                            <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                <span class="content-desc text-center py-2">Redux Development</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            <h2 class="number-main mb-0 text-center">10</h3>
                                <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                    <span class="content-desc text-center py-2">Node.js API Binding in React.js</span>
                                </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            <h2 class="number-main mb-0 text-center">11</h3>
                                <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                    <span class="content-desc text-center py-2">Enterprise Hybrid Model using TypeScript
                                        with React.js</span>
                                </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div class="expertise_tab d-flex align-items-center justify-content-center">
                            <h2 class="number-main mb-0 text-center">12</h3>
                                <div class="pink-bg mb-0 mt-0 d-flex px-3 align-items-center">
                                    <span class="content-desc text-center py-2">React.js Plugin Development</span>
                                </div>
                        </div>
                    </div>
                </div>
