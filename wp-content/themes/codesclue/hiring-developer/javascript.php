...
get_header(); ?>
    ...
    <main class="hiring-main">
        ...
        <section class="hiring-bg hire-angular-developer-bg">
            <div class="container">
                <div class="row align-items-center">
                  <div class="col-lg-7">
                     <h1 class="hiring-h1 text-light">Hire <span class="text-primary">JavaScript</span> Developers</h1>
                     <p class="hiring-des text-light hiring-mt-16">Enhance your web and mobile applications with our expert JavaScript developers. With deep expertise in front-end and back-end development, our JavaScript professionals build high-performing and interactive solutions tailored to your vision.</p>
        ...
        <section class="mt-40-hiring light-blue-hiring">
            <div class="container">
                <h2 class="section-heading text-center">Hire Javascript Developers in just 4 Steps</h2>
...
<section class="expertise-blue-bg">
    <div class="container">
        <h2 class="text-center section-heading text-light">Our Expertise In JavaScript</h2>
        <div class="row justify-content-center">
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-photo-film icon-size-hiring"></i>
                </div>
                <div class="card-text">Media</div>
            </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-cart-shopping icon-size-hiring"></i>
                </div>
                <div class="card-text">Ecommerce</div>
            </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-heart-pulse icon-size-hiring"></i>
                </div>
                <div class="card-text">Healthcare</div>
            </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-building icon-size-hiring"></i>
                </div>
                <div class="card-text">Real Estate</div>
            </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-coins icon-size-hiring"></i>
                </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-brain icon-size-hiring"></i>
                </div>
                <div class="card-text">AI Softwares</div>
            </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-graduation-cap icon-size-hiring"></i>
                </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-file-shield icon-size-hiring"></i>
                </div>
                <div class="card-text">Insurance</div>
            </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-industry icon-size-hiring"></i>
                </div>
                <div class="card-text">Manufacturing</div>
            </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-plane-departure icon-size-hiring"></i>
                </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-oil-well icon-size-hiring"></i>
                </div>
                <div class="card-text">Oil & Gas</div>
            </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-green">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Personalized JavaScript Development</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Our expertise lies in custom JavaScript development that precisely meets your needs. We can create sophisticated commercial software or a dynamic web application that is both scalable and maintainable to grow with your company.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-pink">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Dedicated JavaScript Team</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">You can employ a specialized JavaScript team at CodesClue, and they will work only on your project. Our team of JavaScript developers works as an extension of your company, guaranteeing effective teamwork, transparent communication, and total attention to producing the greatest outcomes.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-perpol">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Comprehensive JavaScript Solutions</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">With each process of JS development, our JavaScript developers from front-end to back-end are specialized and guarantee efficient project management and ongoing assistance. From conception to implementation, we provide end-to-end services.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-yellow">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Focus on Quality</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">At CodesClue, we provide quality and innovation with every project we undertake. Our JavaScript development services are designed to deliver speed, top features, and intuitive UX to keep up with the competitive market.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="mt-40-hiring mb-40-hiring">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4-hiring d-flex align-items-stretch">
                        <img style="margin-top: 16px;" class="border-6-hiring mt-sm-16-hiring" src="<?php echo get_template_directory_uri(); ?>/assets//images/portfolio-img/codesclue-ridereach 1.png" alt="img">
                    </div>
                    <div class="col-lg-8-hiring">
                        <div class="row">
                             <div class="col-lg-6 hiring-mt-16">
                             <div class="project-hiring border-6-hiring">
                                <h4 class="font-24">20+</h4>
                                <p class="content-desc-hiring hiring-mt-16">Project Delivered</p>
                             </div>
                        </div>
                        <div class="col-lg-6 hiring-mt-16">
                             <div class="clients-hiring border-6-hiring">
