...
get_header(); ?>
    ...
    <main class="hiring-main">
        ...
        <section class="hiring-bg hire-android-developer-bg">
            <div class="container">
                <div class="row align-items-center">
                  <div class="col-lg-7">
                     <h1 class="hiring-h1 text-light">Hire <span class="text-primary">Manual</span> QA</h1>
                     <p class="hiring-des text-light hiring-mt-16">Detect usability and functionality issues before they impact your users! Our expert Manual QA testers conduct thorough, hands-on testing to identify bugs, performance bottlenecks, and security vulnerabilities across your application. With meticulous attention to detail, we assess every feature, ensuring your software delivers a flawless, intuitive, and high-performing user experience.</p>
        ...
        <section class="mt-40-hiring light-blue-hiring">
            <div class="container">
                <h2 class="section-heading text-center">Hire Manual QA in Just 4 Steps</h2>
                <p class="content-desc-hiring text-center hiring-mt-16">Looking to hire a QA for your unique project? Look no further, as CodesClue offers a quick and easy 4-step process to connect you with the best talent that meets your requirements.</p>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-3-hiring hiring-mt-16">
                        <span class="tag_step">
                            <i class="fa-solid fa-user-check font-18"></i> Manual Testing
                        </span>
                    </div>
                    <div class="col-lg-3-hiring hiring-mt-16">
                        <span class="tag_step">
                            <i class="fa-solid fa-robot font-18"></i> Automation Testing
                        </span>
                    </div>
                    <div class="col-lg-3-hiring hiring-mt-16">
                        <span class="tag_step">
                            <i class="fa-solid fa-gauge-high font-18"></i> Performance Testing
                        </span>
                    </div>
                    <div class="col-lg-3-hiring hiring-mt-16">
                        <span class="tag_step">
                            <i class="fa-solid fa-code font-18"></i> API Testing
                        </span>
                    </div>
                    <div class="col-lg-3-hiring hiring-mt-16">
                        <span class="tag_step">
                            <i class="fa-solid fa-eye font-18"></i> Usability Testing
                        </span>
                    </div>
                    <div class="col-lg-3-hiring hiring-mt-16">
                        <span class="tag_step">
                            <i class="fa-solid fa-repeat font-18"></i> Regression Testing
                        </span>
                    </div>
                    <div class="col-lg-3-hiring hiring-mt-16">
                        <span class="tag_step">
                            <i class="fa-solid fa-chart-line font-18"></i> Load Testing
                        </span>
                    </div>
                </div>
    ...
    <div class="container">
        <h2 class="text-center section-heading text-light">Our Expertise In Manual QA</h2>
        <div class="row justify-content-center">
            <!-- Card 1 -->
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    <div class="card-number">01</div>
                    <i class="fa-solid fa-magnifying-glass icon-size-hiring"></i>
                </div>
                <div class="card-text">
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-puzzle-piece icon-size-hiring"></i>
                </div>
                <div class="card-text">
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                ...
                <div class="card-text">
                    Cross browsers and Cross device testing
                </div>
            </div>
            <!-- Card 4 -->
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-shield-halved icon-size-hiring"></i>
                </div>
                <div class="card-text">
                    Security Testing
                </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-file-lines icon-size-hiring"></i>
                </div>
                <div class="card-text">
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-vials icon-size-hiring"></i>
                </div>
                <div class="card-text">
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-flask-vial icon-size-hiring"></i>
                </div>
                <div class="card-text">
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-repeat icon-size-hiring"></i>
                </div>
                <div class="card-text">
                    Regression Testing
                </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-ruler-combined icon-size-hiring"></i>
                </div>
                <div class="card-text">
                    Design implementation verification by pixel perfect testing
                </div>
            </div>
            <!-- Card 10 -->
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-mobile-screen-button icon-size-hiring"></i>
                </div>
                <div class="card-text">
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-tachograph-digital icon-size-hiring"></i>
                </div>
                <div class="card-text">
                    Performance Testing
                </div>
            ...
            <div class="col-md-expertise-hirig hiring-mt-16">
                <div class="expertise-card position-relative">
                    ...
                    <i class="fa-solid fa-file-pen icon-size-hiring"></i>
                </div>
                <div class="card-text">
        ...
        <section class="mt-40-hiring">
            <div class="container">
                <h4 class="font-24">Why Hire QA?</h4>
                <h2 class="section-heading hiring-mt-16">How Hiring QA Can Benefit Your Business?</h2>
                <div class="row">
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-green">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Result-Oriented Approach </h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Quality Assurance is the most important part of the SDLC life cycle. We are never satisfied with building a good product. Our passion is towards taking active steps on making it great. This is where Quality Assurance plays a crucial role.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-pink">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Communication And Transparency</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Our QA team works as integral part of development team ensuring seamless correlation of functional requirements and it's technical implementation, thereby reducing communication overhead among all stakeholders.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-perpol">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">Precision-Driven Manual QA</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">Our skilled manual testing team meticulously evaluates applications in real-world scenarios, ensuring seamless functionality, intuitive user experience, and flawless performance. By focusing on usability, responsiveness, and edge-case scenarios, we guarantee a polished and reliable product before it reaches your users.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-stretch hiring-mt-16">
                        <div class="hiring-developers-card bg-hiring-yellow">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="step-hiring-h3">End-to-End Engineering</h3>
                            </div>
                            <p class="content-desc-hiring hiring-mt-16">We take turnkey responsibility for the success of a client's web platform, desktop or custom mobile app. Ensuring successful project delivery with end to end software engineering is our forte.
                            </p>
                        </div>
                    </div>
                </div>
