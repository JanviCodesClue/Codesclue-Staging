<?php
/**
 * Template Name: Hire php Developer Page
 *
 * @package CodesClue
 */
get_header(); ?>
    ...
    <main>
        <!-- Hero section -->
        <section class="main-hero-section php-bg d-flex align-items-center py-cus" id="heroSection">
            <div class="container">
                <div class="row align-items-center g-4">

                    <div class="col-xl-7 col-lg-7 col-md-12 text-lg-start">

                        <h1 class="h1-font-style font-48 mb-2 text-white text-left">Hire PHP Developers
                        </h1>
                        <p class="hero_description fw-500 text-white mb-0 mt-0 text-left">Looking for a PHP developer?
                            Our
                            PHP experts build dynamic, feature-rich, and high-performance web applications with
                            clean and secure code. Get reliable PHP solutions for your web development needs.</p>
            ...
            <div class="container">
                <div class="row mx-0 px-0">
                    ...
                    <div class="col-lg-5 col-12 ps-lg-4 px-0">
                        <h2 class="section-sub-title text-left">Hire PHP Developers in just 4
                            Steps</h2>
                        ...
                        <a href="<?php echo home_url('/hire-php-developer/'); ?>"
        ...
        <section class="section-40 pt-0 service__section" id="serviceSection">
            <div class="container">
                <h2 class="section-title text-left pb-2">Our Expertise In PHP</h2>
                <div class="d-flex mt-md-4  mb-md-0 my-2 justify-content-lg-start justify-content-center flex-wrap">
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                ...
                                <span class="content-desc text-center py-2">Custom PHP Web Development</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">PHP API & Web Service Integration</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">PHP-based CMS Development (WordPress,
                                    Drupal)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">Laravel & CodeIgniter Application
                                    Development</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">E-commerce & Marketplace Development</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">PHP Performance Optimization</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">PHP Cloud Application Development</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4  col-sm-12 col-12 p-md-2 py-2 px-sm-2 px-0">
                        <div
                            ...
                            <div
                                class="backend-expertise-bg text-center mb-0 mt-0 d-flex px-3 align-items-center justify-content-center">
                                <span class="content-desc text-center py-2">PHP Application Maintenance & Support</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="benefit__card__section section-40 mt-2 gap-md-4 gap-3 pb-0">
                    ...
                    <div class="benefit__card  p-md-3 p-2 border-radius">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h3 class="content-sub-title mb-0 text-left">Versatile & Cost-Effective</h3>
                        </div>
                        <p class="content-desc mb-0 mt-md-3 mt-2 text-lg-start ">PHP is a cost-effective and flexible
                            language widely used for web development. It is compatible with all major servers and
                            supports a variety of databases, making it an excellent choice for businesses of all sizes.
                        </p>
                    </div>
                    ...
                    <div class="benefit__card  p-md-3 p-2 border-radius">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h3 class="content-sub-title mb-0 text-left">Fast Development Cycle</h3>
                        </div>
                        <p class="content-desc mb-0 mt-md-3 mt-2 text-lg-start ">PHP's open-source nature and vast
                            library
                            of frameworks (Laravel, CodeIgniter, Symfony) help businesses develop and launch their
                            applications faster with less coding effort.</p>
                    </div>
                    ...
                    <div class="benefit__card  p-md-3 p-2 border-radius">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h3 class="content-sub-title mb-0 text-left">Scalability & High Performance</h3>
                        </div>
                        <p class="content-desc mb-0 mt-md-3 mt-2 text-lg-start ">PHP-based applications are highly
                            scalable
                            and work efficiently even with high traffic. It supports caching mechanisms and integrates
                            seamlessly with cloud environments.</p>
                    </div>
                    ...
                    <div class="benefit__card  p-md-3 p-2 border-radius">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h3 class="content-sub-title mb-0 text-left">Wide Hosting Compatibility</h3>
                        </div>
                        <p class="content-desc mb-0 mt-md-3 mt-2 text-lg-start ">PHP works on almost all hosting
                            services,
                            making it easy to deploy and manage websites or applications without additional server
                            costs.</p>
                    </div>
