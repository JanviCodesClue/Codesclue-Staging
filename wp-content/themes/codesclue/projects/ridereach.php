...
get_header(); ?>
    ...
    <main class="main">
        ...
        <section class="ridereach-hero">
            <div class="ridereach-overlay"></div>
            <div class="container ridereach-container">
                ...
                <div class="col-lg-5 col-md-12 d-flex align-items-center">
                    <!-- Vehicle Image -->
                    <div class="ridereach-vehicle me-3">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio-img/codesclue-ridereach-hero.png" alt="RideReach Vehicle">
                    </div>
                    <!-- Icons Vertical -->
       ...
       <div class="container">
        ...
        <div>
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio-img/project-assets/ridereach.png" >
        </div>
        ...
        <section>
            ...
            <div class="row g-4">
                <!-- Left big image -->
                <div class="col-md-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio-img/project-assets/Transformation.png" alt="Merged Image" class="ridereach-img">
                </div>
...
CodesClue’s Architectural Design for RideReach</h3>
        ...
        <div class="row mb-4">
            <!-- Left side image (merge 2 rows) -->
            <div class="col-lg-4 col-md-12 left-img mb-4 mb-lg-0" rowspan="2">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio-img/project-assets/Brilliance.png" alt="Ride Reach UI">
            </div>
        ...
        <section class="design-system">
            <div class="container">
                <div class="design-system-box">
                    ...
                    <div class="row"> 
                        <div class="col-lg-6">
                            <h2 class="pb-5">Design System</h2>
                            <h4 class="pb-5">Poppins</h4>
                            <div class="pb-5">
                            ...
                            <p class="pb-2">Aa Bb Cc Dd Ee Ff Gg Hh Ii Jj Kk Ll Mm Nn Oo Pp Qq Rr Ss Tt Uu Vv Ww Xx Yy Zz</p>
                        </div>
                         <div class="col-lg-3 justify-content-center text-center ">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio-img/project-assets/designsystem.png" class="mx-auto"/>
                            <p>1D2C3C</p>
                         </div>
                         <div class="col-lg-3 justify-content-center text-center">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio-img/project-assets/designsystem-white.png" class="mx-auto"/>
                            <p>FFFFFF</p>
                         </div>
                    </div>
                </div>
        ...
        <div class="container position-relative">
            ...
            <!-- Left Side Image -->
            <div class="col-lg-6">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio-img/project-assets/ride-reach-TechStack.png" alt="Tech Image" class="techstack-img">
            </div>

            <!-- Right Side Cards Overlapping -->
